...
const DEMO_NFTS: NftCollectible[] = [
  ...
  },
  {
    ...
    chainName: "Solana",
    standard: "spl",
    contractAddress: "J1S9H3QjnRtBbVGHTJZzt2cZ1CqL2y7R1mS33v1JvFvp",
    tokenId: "1",
    name: "Mad Lads #8420",
    collection: "Mad Lads",
    description: "Focal point of the Solana ecosystem. xNFT standard pioneer.",
    mediaTone: "from-orange-500 via-rose-500 to-pink-500",
    floorPriceLabel: "140 SOL",
    ...
    sendStatus: "preview",
    burnStatus: "preview",
    explorerUrl: "https://solscan.io/token/J1S9H3QjnRtBbVGHTJZzt2cZ1CqL2y7R1mS33v1JvFvp",
  },
  {
    id: "tron-apenft-1",
    family: "tron",
    ...
    chainName: "Tron",
    standard: "erc721",
    contractAddress: "TMwFHYBTrE2Kndh7pL9C8J7B9Kx8QvV4zY",
    tokenId: "1337",
    name: "APENFT VIP #1337",
    collection: "APENFT",
    description: "Exclusive access to APENFT marketplace drops and Tron network benefits.",
    mediaTone: "from-red-600 via-red-500 to-orange-500",
    floorPriceLabel: "15,000 TRX",
    ...
    sendStatus: "preview",
    burnStatus: "preview",
    explorerUrl: "https://tronscan.org/#/token721/TMwFHYBTrE2Kndh7pL9C8J7B9Kx8QvV4zY",
  },
  {
