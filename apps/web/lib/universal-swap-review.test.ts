...
describe("universal swap review UI", () => {
  it("queues Jupiter and Rango route reviews through the Acorus extension", async () => {
    ...
    expect(source).toContain("Review Jupiter route in extension");
    expect(source).toContain("Review Rango route in extension");
